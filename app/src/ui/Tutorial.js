...
import Bfemale from '../images/大母雞.png';
...
const dialogData = [
    ...
    {title:'雞種介紹', pic: Smale, animal2pic: Sfemale, animal:'小公雞', animal2:'小母雞', text:'無法交配'},
    {title:'雞種介紹', animalpic:'', animal2pic:'', animal:'中公雞', animal2:'中母雞', text:'交配後產 1~2 顆蛋'},
    {title:'雞種介紹', animalpic:'', animal2pic:'', animal:'大公雞', animal2:'大母雞', text:'交配後產 2~3 顆蛋'},
]
        ...
        return(
            <div className="Tutorial-wrapper">
                    <div className="dialog-box" onClick={this.updateDialog}>
                        ...
                        <FontAwesomeIcon className="nav-icon animatm6ed infinite flash" icon={faCaretDown}/>
                    </div>
